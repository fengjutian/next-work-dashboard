...
const project: LyricProject = { id: '1', title: '夏夜', theme: '告别', style: '流行', emotion: '遗憾', language: '中文', bpm: 72, location: '车站', time: '黄昏', story: '没有说完的告别', coreImages: ['车票', '街灯', '雨'], updatedAt: 0, sections: [
