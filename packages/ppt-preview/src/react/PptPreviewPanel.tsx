...
import { FileText, Upload, X, Plus, Download, Trash2, Edit3, Eye } from "lucide-react";
import { ScrollArea } from "./ScrollArea";
import { INITIAL_PREVIEW_STATE, INITIAL_GENERATE_STATE } from "../core";
import type { PptMode, SlideDraft } from "../core";
import { parsePptxFile, generatePptx } from "../core";
...
export const PptPreviewPanel: React.FC = () => {
  ...
  const addSlide = useCallback(() => {
    setGenerateState((prev) => ({
      ...
      slides: [
        ...prev.slides,
        { id: globalThis.crypto?.randomUUID?.() ?? String(Date.now()), title: "", content: "" },
      ],
    }));
  }, []);
    ...
    <div className="flex flex-col h-full bg-card">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-sm text-foreground">PPT</h2>
        </div>
      ...
      {mode === "preview" && (
        ...
        >
          ...
          {/* 工具栏 */}
          <div className="flex items-center justify-end gap-2 px-4 py-2 border-b bg-card">
